          ...
          <div>
            <div className="flex flex-col items-end gap-2 mb-4">
              <div className="flex flex-col items-end cursor-pointer">
                ...
                >
                  <Label className="text-gray-500">Sort By Votes</Label>
                  <Switch.Control>
                    <Switch.Thumb />
                  </Switch.Control>
                </Switch>
              ...
              <div className="flex flex-col items-end cursor-pointer">
                ...
                >
                  <Label className="text-gray-500">Sort By Favourites</Label>
                  <Switch.Control>
                    <Switch.Thumb />
                  </Switch.Control>
                </Switch>
